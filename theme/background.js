//https://github.com/ayorishy/Island
var Background = /** @class */ (function () {
    ...
    Background.prototype.init = function () {
        ...
        jQuery('#roll').on('scroll.background', function (event) { _this.scroll(event); });
    };
    ...
    Background.prototype.tickHandler = function (delta) {
        var topP = jQuery('#roll').scrollTop();
        var hig = jQuery('#roll').innerHeight();
    ...
    Background.prototype.scroll = function (event) {
        var yPos = jQuery('#roll').scrollTop();
        var hig = jQuery('#roll').innerHeight();
        for (var i = 0; i < this.graphicsAry.length; i++) {
            var accel = this.graphicsAry[i].accel;
