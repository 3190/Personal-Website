      ...
      <div class="wrpr">
        <p>
          ...
          <?php echo "网站勉强运行了"; echo getBuildTime(); ?>
           <br>
           Powered by<a href="https://typecho.org/" target="_blank" data-pjax-state=""> Typecho </a> Theme by<a href="https://github.com/Ion1y/Island" data-pjax-state=""> Island </a>
           <br>
        ...
        <p><span>
            ...
            <a href="https://icp.gov.moe/?keyword=<?php $this->options->meowicp() ?>" target="_blank" style="color: inherit;">萌ICP备<?php $this->options->meowicp() ?>号</a>
